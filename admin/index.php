                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Survey Portal Admin panel!</h1>
                                </div>
...
if (isset($_POST['sub_log'])) {
    ...
    $login = $db_handle->numRows("SELECT * FROM admin WHERE email='$email' and password='$password'");

    $login_data = $db_handle->runQuery("SELECT * FROM admin WHERE email='$email' and password='$password'");
